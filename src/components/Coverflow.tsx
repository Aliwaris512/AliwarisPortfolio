...
export function CoverFlow({
  ...
  return (
    <>
      ...
      <motion.div
        ref={containerRef}
        className={`group/cf relative w-full h-full flex flex-col justify-center items-center overflow-hidden bg-transparent focus:outline-none touch-pan-y ${isDragging ? 'is-dragging cursor-grabbing' : 'cursor-grab'
          } ${className ?? ''}`}
